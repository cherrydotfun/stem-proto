<template>
  <div class="chat-page">
    <div class="page-container" :class="{ 'menu-collapsed': isMenuCollapsed, 'mobile-menu-open': !isMenuCollapsed && isMobile }">
      <!-- Боковое меню -->
      <div class="menu-container" :class="{ 'mobile-menu': isMobile }">
            ...
            <div class="collapsed-chats">
              <div 
                ...
                :class="{
                  ...
                  'active-chat': chatPeer?.toBase58() === peer.pubkey.toBase58()
                }"
              >
        ...
        <div class="menu-content" v-show="!isMenuCollapsed">
          <MenuComponent
            ...
            :currentChat="chatPeer ?? undefined"
      ...
      <div class="chat-container">
        <div v-if="chatPeer" class="chat-container-inner">
          <div class="chat-header">
            ...
            <button v-if="isMobile" class="mobile-menu-button" @click="toggleMenu">
              ☰
            </button>
        ...
        <div v-else class="chat-placeholder">
          ...
          <button v-if="isMobile" class="mobile-menu-button placeholder-menu-button" @click="toggleMenu">
            ☰
          </button>
      ...
      <div v-if="isMobile && !isMenuCollapsed" class="mobile-overlay" @click="toggleMenu"></div>
    </div>
  </div>
</template>
