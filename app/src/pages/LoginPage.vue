<template>
  <div class="login-container">
    <div class="login-card">
      ...
      <div v-if="!publicKey" class="wallet-selection">
        ...
        <div class="wallet-buttons">
          <button
            ...
            class="wallet-button"
          >
            <span class="wallet-icon">{{ name === 'Phantom' ? '👻' : '🔑' }}</span>
      ...
      <!-- Регистрация -->
      <div v-if="publicKey && !walletDescriptor.isRegistered" class="registration">
        <div class="registration-message">
          <p>Account is not registered in Cherry Chat</p>
          <p class="registration-subtitle">You need to register to start chatting</p>
        </div>
